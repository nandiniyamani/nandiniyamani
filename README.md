...
💬I'm seeking full-time opportunites in Design verification, RTL & FPGA design roles.
...
• **Verification Methodologies**: UVM (TLM, TLM2.0), Constrained-Random Verification, Verification Plans, Testbenches
• **Communication Protocols**: UART, SPI, I2C, AHB, APB, PCIe  
• **Protocols & Operating Systems**: PCIe, Ethernet, IP, AXI4, AHB, UART, SPI, I2C, UNIX, Linux
